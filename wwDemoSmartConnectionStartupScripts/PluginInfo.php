...
class wwDemoSmartConnectionStartupScripts_EnterprisePlugin extends EnterprisePlugin
{
	public function getPluginInfo()
	{ 
		require_once BASEDIR.'/server/interfaces/plugins/PluginInfoData.class.php';
		$info = new PluginInfoData(); 
		$info->DisplayName = 'ww Demo Smart Connection Startup Scripts';
		$info->Version     = '10.5 20190620'; // don't use PRODUCTVERSION
		$info->Description = '<enter your description here>';
